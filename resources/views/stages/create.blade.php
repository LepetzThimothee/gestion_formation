            ...
            <div class="text-center">
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group">
                        ...
                        <input id="session" type="text" name="session" class="form-control" placeholder="numéro de session du stage" value="{{ $cession + 1 }}">
                        @error('session')
                ...
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group">
                        ...
                        <input id="intitule" type="text" name="intitule" class="form-control" placeholder="intitulé du stage">
                        @error('intitule')
                        <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group">
                        ...
                        <input id="cout_pedagogique" type="text" name="cout_pedagogique" class="form-control" placeholder="coût pedagogique">
                ...
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group">
                        ...
                        <input id="duree" type="text" name="duree" class="form-control" placeholder="durée de formation">
                        @error('duree')
                        <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
                        @enderror
                    </div>
